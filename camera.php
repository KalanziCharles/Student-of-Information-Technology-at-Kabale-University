...
$sql = "SELECT id, camera_name, location, status, Last_active FROM camera"; // Example query
...
<head>
  ...
  <title>Camera - Intelligent Camera Tracking System</title>
  ...
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="navbarNav">
      <ul class="navbar-nav ms-auto">
        <li class="nav-item">
          <a class="nav-link active" href="camera.php">Camera</a>
        </li>
        <li class="nav-item">
